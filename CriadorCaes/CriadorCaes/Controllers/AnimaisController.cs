...
namespace CriadorCaes.Controllers
{
    public class AnimaisController : Controller
    {
        ...
        // GET: Animais/Create
        /// <summary>
        /// Mostra o forumulário de criação deu um novo animal
        /// </summary>
        /// <returns></returns>
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,DataNascimento,DataCompra,Sexo,NumLOP,CriadorFK,RacaFK")] Animais animal)
        {
            ...
            // só se avança, se forem corretos. Isto é, se respeitarem as regras
            //definidas no Model
 ...
 //adicionar os dados do animal à BD
                ...
                return RedirectToAction(nameof(Index));
                    ...
                    ModelState.AddModelError("", "Ocorreu um erro com a adição dos dados do animal" + animal.Nome);
                    //throw;
                }
